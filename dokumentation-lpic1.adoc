...
kai@debian10:~$ # 1. Schreibe  Programme, die genau eine Aufgabe erfüllen
kai@debian10:~$ # diese Aufgabe sollen diese Programme GUT machen
kai@debian10:~$ # 2. Text ist ein universelles Format
kai@debian10:~$ # 3. Programme sollen also Text(stroeme) verarbeiten koennen
